 ...
 * `type: 'cancellation'` or `type: 'reminder'` payloads. This script (idempotent
 * per appointment_id — retries never duplicate emails or sheet rows):
 *
 ...
 *    + testCancellation() + testReminder() once to authorize Gmail + Sheets.
